...
const PlacesScreen = () => {
  ...
  const data = [
    {
      ...
      shortDescription: " région du Sénégal : métropole",
      properties: [
        {
          id: "10",
          name: "Azalai Hotel",
        ...
        },
        {
          ...
          rating: 4,
          address:
            "Avenue Abdoulaye Fadiga ,Dakar 18524",
          oldPrice: 42010,
          newPrice: 33270,
          latitude: "12.9784",
          longitude: "77.6408",
    ...
    },
    {
      ...
      shortDescription: " la ville de Saint-Louis ...",
      properties: [
        {
          id: "20",
  ...
  const filters = [
    {
      id: "0",
      filter: "Coût: du + bas au + élevé",
    },
    {
      id: "1",
      filter: "Coût: du + élevé au + bas",
    },
  ];
  ...
  return (
    <View>
      ...
      <BottomModal
        ...
        modalTitle={<ModalTitle title="trier et filtrer" />}
        modalAnimation={
          new SlideAnimation({
            slideFrom: "bottom",
          })
      ...
      >
        <ModalContent style={{ width: "100%", height: 280 }}>
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <Text style={{ textAlign: "center" }}>Trier </Text>
            </View>

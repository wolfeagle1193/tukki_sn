...
const PlacesbyRegion = ({ item }) => {
  ...
  return (
    <TouchableOpacity
      onPress={() => navigation.navigate("Regiondetails", item)}
    >
      <View style={styles.container}>
...
const styles = StyleSheet.create({
  ...
  overlay: {
    ...
    right: 0,
    bottom: 0,
    backgroundColor: "rgba(0, 0, 0, 0.1)", // Ajustez l'opacité ici si nécessaire
    zIndex: 1,
  },
  textOverlay: {
    position: "absolute",
